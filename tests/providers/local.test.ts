...
function createMockDiscovery(cognitives: Array<{ name: string; description: string; path: string; type: string; rawContent: string; metadata: Record<string, unknown> }> = []) {
  return {
...
describe('LocalProvider', () => {
  it('matches relative path ./', () => {
    ...
    const provider = new LocalProvider(fs, createMockDiscovery(), createCapturingEventBus(), '/home/user');
